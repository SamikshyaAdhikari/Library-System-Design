...
public class TestData {
	...
	List<LibraryMember> allMembers = new ArrayList<LibraryMember>(){
		{
			add(new LibraryMember("Ram","Ghimire","786",addresses.get(0),"1234"));
			add(new LibraryMember("Shyam","Ghimire","756",addresses.get(1),"1284"));
			add(new LibraryMember("Ramesh","Ranjet","886",addresses.get(2),"2234"));
			add(new LibraryMember("Rama","Pokheral","986",addresses.get(3),"9234"));
		}
	};
